      ...
      <main style={mainContainerStyle}>
        <div style={sectionCardStyle}>
          ...
          <div style={{ marginBottom: "1rem" }}>
            <button onClick={() => setShowAddMedicine(true)} style={addNewMedicineButtonStyle}>
                        ...
                        {batches.map((batch: any) => {
                          ...
                          return (
                            <tr key={batch.batch_id}>
                              ...
                              <td style={{ ...nestedTdStyle, color: isExpired ? "#dc2626" : "#2563eb" }}>{expiry.toLocaleDateString()} {isExpired ? "(Expired)" : ""}</td>
                              <td style={{ ...nestedTdStyle, color: isExpired ? "#dc2626" : "#2563eb", fontWeight: 600 }}>
                              ...
                              {selectedFilter === "mainStock" && (
                                <td style={{ ...nestedTdStyle, textAlign: "center" }}>
                                  <button onClick={() => handleDeleteBatch(batch.batch_id)} style={deleteButtonStyle}><Trash2 size={12} /> Delete</button>
                                </td>
                              )}
                            </tr>
                          );
...
const subFilterInputStyle: React.CSSProperties = {
