...
import * as AddMedicineController from "../controllers/ca/addmedicine.controller.js";
...
router.post(
  ...
  authenticate,
  authorize(ROLES.CLERICAL_ASSISTANT),
  AddMedicineController.addSingleMedicine
);
...
router.post(
  ...
  authorize(ROLES.CLERICAL_ASSISTANT),
  upload.single("file"),
  AddMedicineController.addBulkMedicines
);
